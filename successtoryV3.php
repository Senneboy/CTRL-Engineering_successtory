...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;700&display=swap" rel="stylesheet">
    ...
    <style>
        /* ---TEXT CONTAINER --- */
        .containerNew {
            max-width: 500px;      /* width white container */
            margin: -100px auto 0 auto;        /* "50px auto" for space between banner and container  + "0 auto" center container */
            background: <?php echo $container_color; ?>;
            min-height: 200vh; /* hight of container = height of page */
            padding: 200px;
            overflow: visible;
            }
...
<div class="containerNew">
    ...
    <section class="text-section">
        ...
        <h2> <mark><b>Long story short</b></h2>
            ...
            <div class="control" id="prev">
                <svg width="70" height="70" viewBox="0 0 58 50">
                    <g transform="rotate(90 29 25)">
                        ...
                        points="29,1 51,13 51,37 29,49 7,37 7,13"/>
                    </g>
